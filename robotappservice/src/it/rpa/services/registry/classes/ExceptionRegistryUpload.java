...
@WebServlet("/ExceptionUpload")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 10, // 10MB
		maxFileSize = 1024 * 1024 * 10, // 10MB
		maxRequestSize = 1024 * 1024 * 50)
// 50MB
public class ExceptionRegistryUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final int NUM_COL_EXCEPTION_REGISTRY_TEMPLATE = 2;
	private static final int COL_KEY_EXCEPTION_REGISTRY_TEMPLATE = 1;
	 ...
	 */
	public ExceptionRegistryUpload() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			fileError = CommonMethods.readExcelFile(inputFile, eCbean, NUM_COL_EXCEPTION_REGISTRY_TEMPLATE,
					COL_KEY_EXCEPTION_REGISTRY_TEMPLATE);
			if (null != fileError && !fileError.isEmpty()) {
				...
				// richiamo EJB
				result = registry.insertExceptionFromExcel(eCbean);
